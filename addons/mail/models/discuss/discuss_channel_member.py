...
from ...tools import jwtx, discuss
...
class ChannelMember(models.Model):
    ...
    def _get_rtc_server_info(self, rtc_session, ice_servers=None, key=None):
        ...
        json_web_token = jwtx.sign(claims, key=key, ttl=60 * 60 * 8, algorithm=jwtx.Algorithm.HS256)  # 8 hours
